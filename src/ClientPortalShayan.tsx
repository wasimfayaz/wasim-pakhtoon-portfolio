...
const MESSAGES = [
  {
    ...
    role: "Director",
    text: "Hey Shayan, Draft V1 of the main film is now live in your Deliverables tab. Let me know what you think of the color grading!",
    time: "Apr 16 · 10:24 AM",
    isMe: false,
  },
  {
    id: 2,
    sender: "Shayan Ahmad Donoo",
    role: "Client",
    text: "Looks incredible! The contrast is perfect. Can we just tweak the ending title font?",
    time: "Apr 16 · 2:41 PM",
    isMe: true,
  },
  {
...
const DEMO_PASSWORD = "shayan2025";
...
export default function ClientPortalShayan() {
